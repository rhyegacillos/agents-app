...
async def extract_memory_candidates(
    ...
    system = (
        ...
        "5) Explicitness: Only store when the user explicitly states a lasting preference or constraint "
        "(e.g., 'I prefer...', 'Always...', 'From now on...'). Do NOT infer.\n"
        "6) Durability filter: Only store items likely to remain useful for weeks+. Ignore one-off tasks, ephemeral context, "
        "and transient states.\n"
        "7) One-off exclusion: If the request is about a single task or a one-time output (e.g., 'generate a PDF for this'), "
        "skip it.\n"
        "8) Do NOT store transient failures or delivery issues unless the user explicitly states it as an ongoing, durable preference/constraint.\n"
        ...
        "12) Evidence: excerpt MUST be a short verbatim snippet from the conversation provided. "
        "It must include the durability cue (e.g., 'prefer', 'always') and be at least 5 words.\n"
